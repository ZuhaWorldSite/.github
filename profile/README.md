...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/zuhaworldsite/zuhaWorld.git
   ```
...
## Contact
For any questions, feel free to [reach out to the team](mailto:zuha@zuha.site).
